...
public class SwerveModule {
   ...
   * Encoder.
   */
  public SwerveModule(int drivingCANId, int turningCANId, double chassisAngularOffset, boolean driveReverseMotor) {
    m_drivingSparkMax = new SparkMax(drivingCANId, MotorType.kBrushless);
    m_turningSparkMax = new SparkMax(turningCANId, MotorType.kBrushless);

    // Set drive motor as reversed
    m_drivingSparkMax.setInverted(driveReverseMotor);
